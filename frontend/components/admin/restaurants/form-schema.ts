...
export const restaurantFormSchema = z.object({
  ...
  slug: z
    ...
    .regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, "Slug: მხოლოდ a-z, 0-9 და ტire"),
  description: z.string(),
  categories: z.array(z.string()).min(1, "აირჩიეთ მინიმუმ ერთი კატეგორია"),
  ownerName: z.string().min(1, "მფლობელის სახელი სავალდებულოა"),
  ownerEmail: z.string().email("არასწორი email"),
  ownerPhone: z.string().min(1, "ტელეფონი სავალდებულოა"),
